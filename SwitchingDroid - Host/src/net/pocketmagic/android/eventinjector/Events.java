...
public class Events
{
	...
	public class InputDevice {
		...
		public int SendTouchDownAbs(int x, int y ) {
			...
			intSendEvent(m_nId, EV_ABS, 47,0);			//?
			intSendEvent(m_nId, EV_ABS, 48,10);			//?
			intSendEvent(m_nId, EV_ABS, 53,x);			//x 좌표
			intSendEvent(m_nId, EV_ABS, 54,y);			//y 좌표
					//intSendEvent(m_nId, EV_ABS, 57, 20);
			intSendEvent(m_nId, EV_ABS, 58, 20);			//터치압
			intSendEvent(m_nId, 0, 0, 0);
			
			//터치 업
			intSendEvent(m_nId, EV_ABS, 58, -1);
			intSendEvent(m_nId, 0, 0, 0);
			...
			intSendEvent(m_nId, EV_ABS, 24,0);
			intSendEvent(m_nId, EV_ABS, 28,0);
			Log.d(TAG, "touch down aaaaaaaaaaaaaaaaaa");
			...
			intSendEvent(m_nId, EV_ABS, 24,0);
			intSendEvent(m_nId, EV_ABS, 28,0);
			Log.d(TAG, "touch up aaaaaaaaaaaaaaaaaa");*/
		...
		//################################################################
		/**영광 터치 다운*/
		public int mTouchDown(int x, int y ) {
			intSendEvent(m_nId, 1, 330, 1); 
			intSendEvent(m_nId, EV_ABS, 47,0);			//?
			intSendEvent(m_nId, EV_ABS, 48,10);			//?
			intSendEvent(m_nId, EV_ABS, 53,x);			//x 좌표
		...
		/**영광 무브*/
		public int mTouchMove(int x, int y ) {
			/*intSendEvent(m_nId, 1, 330, 1); 
			intSendEvent(m_nId, EV_ABS, 47,0);			//?
			intSendEvent(m_nId, EV_ABS, 48,10);			//?
*/			intSendEvent(m_nId, EV_ABS, 53,x);			//x 좌표
		...
		/**영광 터치 업*/
		public int mTouchUp(int x, int y ) {
			intSendEvent(m_nId, EV_ABS, 58, -1);
			intSendEvent(m_nId, 0, 0, 0);
